...
})({"f5d4E":[function(require,module,exports,__globalThis) {
...
if (signUpForm) document.querySelector('.form').addEventListener('submit', (e)=>{
    e.preventDefault();
...
if (userDataForm) userPasswordForm.addEventListener('submit', async (e)=>{
    e.preventDefault();
...
},{"core-js/modules/web.immediate.js":"49tUX","regenerator-runtime/runtime":"dXNgZ","./mapbox":"3zDlz","./login":"7yHem","./updateSettings":"l3cGY","./stripe":"10tSC","./signUp":"a26Sx"}],"49tUX":[function(require,module,exports,__globalThis) {
'use strict';
...
const displayMap = (locations)=>{
    mapboxgl.accessToken = 'pk.eyJ1Ijoic2Frc2hhbXNhbmtobGE3NjciLCJhIjoiY21hMnUzdWExMmY5MzJxc203dGlpM3VrNCJ9.fj6dEYrfy5B9n6_6nIUKfw';
    const map = new mapboxgl.Map({
        container: 'map',
        style: 'mapbox://styles/sakshamsankhla767/cma2uqu5400dv01r075alersi',
        scrollZoom: false
    });
...
const updateSettings = async (data, type)=>{
    try {
        ...
        if (res.data.status === 'success') (0, _alert.showAlert)('success', `${type.toUpperCase()} Updated Succesfully`);
    } catch (err) {
        (0, _alert.showAlert)('error', err.response.data.message);
    }
};

},{"axios":"jo6P5","./alert":"kxdiQ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"10tSC":[function(require,module,exports,__globalThis) {
/* eslint-disable */ var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const bookTour = async (tourId)=>{
    const stripe = await (0, _stripeJs.loadStripe)('pk_test_51RKzeHQY2l6abGZUoPntw4XnlxYRnmejSxkXjRfGAGJGumtsc7FVQJ42Ai6ggPxwS8Q2GWddiMHBXeRvvm2SXwdM005SZVbHBp');
    try {
        // 1) Get Checkout session
        const response = await (0, _axiosDefault.default).get(`http://localhost:3000/api/v1/booking/checkout-session/${tourId}`);
...
},{"axios":"jo6P5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./alert":"kxdiQ","@stripe/stripe-js":"8ZdZI"}],"8ZdZI":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _indexMjs = require("../dist/index.mjs");
parcelHelpers.exportAll(_indexMjs, exports);

},{"../dist/index.mjs":"dHqHx","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"dHqHx":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
var initStripe = function initStripe(maybeStripe, args, startTime) {
    ...
    if (isTestKey && version !== expectedVersion) console.warn("Stripe.js@".concat(version, " was loaded on the page, but @stripe/stripe-js@").concat("7.3.0", " expected Stripe.js@").concat(expectedVersion, ". This may result in unexpected behavior. For more information, see https://docs.stripe.com/sdks/stripejs-versioning"));
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"a26Sx":[function(require,module,exports,__globalThis) {
/* eslint-disable */ var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"axios":"jo6P5","./alert":"kxdiQ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["f5d4E","f2QDv"], "f2QDv", "parcelRequire11c7", {})
